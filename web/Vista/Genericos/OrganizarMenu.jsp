<%-- 
    Document   : OrganizarMenu
    Created on : 04/12/2021, 04:14:13 AM
    Author     : Paz
--%>
                    ...
                    <div class="row">
                        <div class="col-md-6 order-md-1">
                            <div class="card border-light my-2 p-1 bg-body rounded shadow-sm">
                                <div class="card-body">
                                    <h4><i class="fas fa-list-ol"></i> Seleccionar categorías para tu Menú</h4>
                                    <hr class="mb-4">
                            ...
                            <div class="card border-light my-2 p-1 bg-body rounded shadow-sm">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div id="order-left" class="list-group">
                                                <form action="Vista/Genericos/SeleccionarRecetaSubmit.jsp" >

                                                    <c:forEach var="comida" items="${comidas}">

                                                        <input class="form-check-input"  name="check" type="checkbox"  value="${comida.getNom()}"/>
                                                        ${comida.getNom()}</p>

                                                    </c:forEach>

                                                    <button type="submit" name="seleccionarComidas" value="seleccionarComidas" class="btn btn-success btn-circle w-100">
